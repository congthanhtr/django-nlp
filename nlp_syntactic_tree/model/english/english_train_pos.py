...
initial_tagger = backoff_tagger(train_data, [AffixTagger,UnigramTagger,BigramTagger, TrigramTagger], backoff=default_tagger)
...
# save pickle
path="./model/english/pos_trained.pkl"
# path =  "D:\\repos\\django-nlp-master\\nlp_syntactic_tree\\model\\english\\pos_trained.pkl"
# import os
# BASE_DIR   = os.path.dirname(os.path.realpath(__file__)) 

# path  = BASE_DIR + '/pos_trained.pkl'
# #path =  "./model/english/pos_trained.pkl"
...
text = "recently i feel like she really enjoys playing tennis."
